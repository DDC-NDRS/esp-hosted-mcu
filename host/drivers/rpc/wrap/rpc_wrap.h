...
esp_err_t rpc_wifi_init(wifi_init_config_t const* arg);
...
esp_err_t rpc_wifi_set_mac(wifi_interface_t mode, uint8_t const mac[6]);

esp_err_t rpc_wifi_scan_start(wifi_scan_config_t const* config, bool block);
...
esp_err_t rpc_wifi_set_country_code(char const* country, bool ieee80211d_enabled);
esp_err_t rpc_wifi_get_country_code(char* country);
esp_err_t rpc_wifi_set_country(wifi_country_t const* country);
esp_err_t rpc_wifi_get_country(wifi_country_t* country);
esp_err_t rpc_wifi_ap_get_sta_list(wifi_sta_list_t* sta);
esp_err_t rpc_wifi_ap_get_sta_aid(uint8_t const mac[6], uint16_t* aid);
...
esp_err_t rpc_ota(char const* image_url);
