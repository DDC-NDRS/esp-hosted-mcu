...
static esp_err_t _hosted_ota(char const* image_url) {
...
static esp_err_t esp_hosted_slave_ota_chunked(char const* image_url) {
    uint8_t ota_retry = 2;
    int     ret       = 0;
...
static esp_err_t esp_hosted_slave_ota_whole_image(char const* image_path) {
    FILE* f                     = NULL;
