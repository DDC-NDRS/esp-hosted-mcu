...
WEAK esp_err_t esp_wifi_init(wifi_init_config_t const* config) {
...
WEAK esp_err_t esp_wifi_scan_start(wifi_scan_config_t const* config, bool block) {
...
WEAK esp_err_t esp_wifi_set_country(wifi_country_t const* country) {
...
WEAK esp_err_t esp_wifi_set_mac(wifi_interface_t ifx, uint8_t const mac[6]) {
...
WEAK esp_err_t esp_wifi_ap_get_sta_aid(uint8_t const mac[6], uint16_t* aid) {
...
WEAK esp_err_t esp_wifi_set_country_code(char const* country, bool ieee80211d_enabled) {
